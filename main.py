...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        self.root.title("Attendance Taking and Management System")
...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Automatic Attendance System Using Face Recognition",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        att_b1_1.place(x=710,y=280,width=180,height=45)
         ...
         # add teacher  button 4
        hlp_img_btn=Image.open("Images_GUI/teach.png")
        hlp_img_btn=hlp_img_btn.resize((180,180),Image.ANTIALIAS)
        self.hlp_img1=ImageTk.PhotoImage(hlp_img_btn)

        hlp_b1 = Button(bg_img,command=self.regteach,image=self.hlp_img1,cursor="hand2",)
        hlp_b1.place(x=940,y=100,width=180,height=180)

        hlp_b1_1 = Button(bg_img,command=self.regteach,text="Add teacher",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
