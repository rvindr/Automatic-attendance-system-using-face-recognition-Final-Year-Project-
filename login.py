...
class Login:
    def __init__(self,root):
        ...
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="#002B53",activeforeground="orange",activebackground="#002B53")
