...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        # std_img_btn=Image.open("Images_GUI/m.jpg")
        ...
        det_img_btn=Image.open("Images_GUI/ravi.png")
        ...
        det_b1_1 = Button(bg_img,text="Ravinder",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
