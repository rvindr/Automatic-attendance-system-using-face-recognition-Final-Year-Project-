...
class Register:
    def __init__(self,root):
        ...
        get_str = Label(frame,text="Add Teacher",font=("times new roman",30,"bold"),fg="#002B53",bg="#F2F2F2")
        ...
        loginbtn=Button(frame,command=self.reg,text="Register",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="#002B53",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=103,y=510,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="#002B53",activeforeground="white",activebackground="#007ACC")
